...
L1688={'size_x' : 9, 'size_y' : 7, 
    ...
    'distance' : 119.*u.pc, 'beam_pos' : 'bottom left',
...
#    'mom0_max' : np.array([ 5.0,   1.8,   0.90,  1.4,   0.70,  0.70,  0.90]),
    'mom0_max' : np.array([11.0,   1.8,   0.90,  1.4,   0.70,  0.70,  0.90]),
    'mom0_stretch' : 'log',
...
#    'mom0_max' : np.array([ 6.0,  5.0 ,  3.00,  1.8,  0.8,  0.8,  1.5]),
    'mom0_max' : np.array([ 15.0,  2.0 ,  3.00,  1.8,  0.8,  0.8,  1.5]),
    'mom0_stretch' : 'log',
    'pmin_list': np.array([-5,0,5,2.73,13]),
...
#    'mom0_max' : np.array([ 8.0,  2.0 ,  0.75,  1.8,  0.8,  0.8,  1.5]),
    'mom0_max' : np.array([ 45.0,  10.0 ,  0.75,  1.8,  0.8,  0.8,  1.5]),
    'mom0_stretch' : 'log',
    'pmin_list': np.array([-5,0,5,2.73,13]),
