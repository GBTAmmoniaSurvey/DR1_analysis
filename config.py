...
#    'mom0_max' : np.array([ 5.0,   1.8,   0.90,  1.4,   0.70,  0.70,  0.90]),
    ...
    'mom0_stretch' : 'log',
    'pmin_list': np.array([2.5,0,5,3,13]),
    'pmax_list': np.array([4.7,2,30,15,15.5]),
...
#    'mom0_max' : np.array([3.0, 0.5, 0.5, 1.8, 1.4, 1.0, 1.5]),
    ...
    'mom0_stretch' : 'linear',
    'pmin_list': np.array([5.0,0,6,3,13]),
    'pmax_list': np.array([7.0,0.5,15,15,14.5]),
...
#    'mom0_max' : np.array([ 6.0,  5.0 ,  3.00,  1.8,  0.8,  0.8,  1.5]),
    ...
    'mom0_stretch' : 'log',
    'pmin_list': np.array([5.3,0,5,3,13]),
    'pmax_list': np.array([9.1,1,25,15,15]),
...
#    'mom0_max' : np.array([ 8.0,  2.0 ,  0.75,  1.8,  0.8,  0.8,  1.5]),
    ...
    'mom0_stretch' : 'log',
    'pmin_list': np.array([5.0,0,5.0,3.,13]),
    'pmax_list': np.array([13,2,40,15,15.5]),
    'p_step': np.array([1,0.4,10,3,0.5]),
    'w11_step' : 0.3*3 }
